...
/**
  ...
  /**
   * `prisma.durian`: Exposes CRUD operations for the **Durian** model.
    * Example usage:
    * ```ts
    * // Fetch zero or more Durians
    * const durians = await prisma.durian.findMany()
    * ```
    */
  get durian(): Prisma.DurianDelegate<ExtArgs, { omit: OmitOpts }>;
}
